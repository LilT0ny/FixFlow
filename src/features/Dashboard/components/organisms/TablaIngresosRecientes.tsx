  ...
  return (
      <div className="bg-white rounded-[20px] md:rounded-[32px] border border-surface-200 shadow-sm overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <button 
          ...
          className="w-full sm:w-auto group flex items-center justify-center gap-1.5 px-4 py-2.5 bg-surface-50 hover:bg-primary-50 text-surface-600 hover:text-primary-600 rounded-xl transition-all duration-300 active:scale-95 border border-surface-100"
        >
          <span className="text-[10px] md:text-xs font-black uppercase tracking-tight">Ver Dashboard Completo</span>
        ...
        <table className="w-full text-left border-collapse min-w-[500px] md:min-w-0">
          <thead>
            <tr className="bg-surface-50/50 text-[10px] font-black text-surface-400 uppercase tracking-[0.25em] border-b border-surface-100">
              ...
              <th className="px-6 md:px-8 py-5 hidden md:table-cell">
                <div className="flex items-center gap-2">
                  <Smartphone className="w-3.5 h-3.5" />
                  Equipo
                </div>
              </th>
              <th className="px-6 md:px-8 py-5 hidden sm:table-cell">Estado</th>
              ...
              <tr key={orden.id} className="hover:bg-surface-50/70 transition-colors group">
                ...
                <td className="px-6 md:px-8 py-5">
                  ...
                  <div className="sm:hidden mt-2">
                     <span className={`inline-flex items-center px-2 py-1 rounded-full text-[8px] font-black uppercase tracking-widest border shadow-sm ${getStatusColor(orden.status)}`}>
